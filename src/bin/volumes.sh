...
docker volume create --name "openhab-userdata" --label "com.docker.compose.project=openhab" --label "com.docker.compose.version=2.35.1" --label "com.docker.compose.volume=openhab-userdata"

docker volume create --name "sonarqube-data" --label "com.docker.compose.project=sonarqube" --label "com.docker.compose.version=2.35.1" --label "com.docker.compose.volume=sonarqube-data"
docker volume create --name "sonarqube-extensions" --label "com.docker.compose.project=sonarqube" --label "com.docker.compose.version=2.35.1" --label "com.docker.compose.volume=sonarqube-extensions"

docker volume create --name "portainer_data" --label "com.docker.compose.project=portainer" --label "com.docker.compose.version=2.35.1" --label "com.docker.compose.volume=portainer_data"

docker volume create --name "postgresql" --label "com.docker.compose.project=postgresql" --label "com.docker.compose.version=2.35.1" --label "com.docker.compose.volume=postgresql"
docker volume create --name "postgresql-data" --label "com.docker.compose.project=postgresql" --label "com.docker.compose.version=2.35.1" --label "com.docker.compose.volume=postgresql-data"
